...
def get_csv_dataset(args, preprocess_fn, is_train, epoch=0, guidance=None, ori_proportion=None, uniform_guid=False,
                    return_guidance=False, return_img_id=False, datalimit=-1, logger=None, list_imgs=None,
                    merge_ori=False, subsample=False, return_train_cnt=False):
    ...
    dataset = CsvDataset(input_filename, preprocess_fn, logger=logger, img_key=args.csv_img_key,
                         ...
                         return_img_id=return_img_id, ori_proportion=ori_proportion, return_train_cnt=return_train_cnt)
...
def get_data(args, preprocess_fns, logger=None, epoch=0, guidance=None, ori_proportion=None, uniform_guid=False,
             datalimit=-1, merge_ori=False, subsample=False, return_img_id=False, list_imgs=None):
    preprocess_train, preprocess_val = preprocess_fns
    data = {}
