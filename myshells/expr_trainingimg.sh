...
#SBATCH --job-name=flyp_loss_trainimg
#SBATCH --output=flyp_loss_trainimg.out.%j
#SBATCH --error=flyp_loss_trainimg.out.%j
...
SAVED_FOLDER="../data/metadata/clip_progress_train_img/"
